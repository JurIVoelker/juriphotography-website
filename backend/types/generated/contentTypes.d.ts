...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    images: Schema.Attribute.Component<'content.image', true>;
...
export interface ApiPagePicturesPagePictures extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    profile: Schema.Attribute.Component<'content.image-text', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
